        ...
        <div class="row">
            ...
            <div class="col-md-12">
                ...
                <div class="card card-primary">
                    ...
                    <form id="ajouter_pays">
                        @csrf
                        <div class="card-body">
                            <div class="form-group">
                                <label for="exampleInputText0">Pays</label>
                    ...
                    <div class="card-body">
                        <table id="example1" class="table table-bordered table-striped">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td>{{$pays->id}}</td>
                                    <td>{{strtoupper($pays->nom)}}</td>
                                    <td>{{$pays->created_at}}</td>
                                    <td>
                                        <form class="update">
                                            @csrf
                                            <input type="hidden" value="{{$pays -> id}}" name="id">
                                            <input type="hidden" value="{{$pays -> nom}}" name="nom">
                                    ...
                                    <td>
                                        <form class="delete">
                                            @csrf
                                            <input type="hidden" id="id" value="{{$pays -> id}}" name="id">
...
$(function() {
    ...
    $('#ajouter_pays').submit(function() {
        event.preventDefault();
        $('#loader').fadeIn();
        $.ajax({
            type: 'POST',
            url: 'pays/ajouterPays',
            //enctype: 'multipart/form-data',
            data: $('#ajouter_pays').serialize(),
            datatype: 'json',
    ...
    document.querySelectorAll('.delete').forEach(_formNode => {
        _formNode.addEventListener('submit', _event => {
            ...
            Swal.fire({
                icon: "question",
                title: "Etes vous sur de vouloir supprimer ce pays?",
                text: "Cela pourrait entrainer la suppression automatique des donnés lié au pays",
